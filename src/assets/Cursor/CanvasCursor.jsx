...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      return <h1>Something went wrong with the canvas component.</h1>;
    }
...
const useCanvasCursor = () => {
  ...
  const renderCanvas = function () {
    ...
    if (!canvas2) {
      ...
      return; // Exit early if canvas is not found
    }
...
// Wrap the CanvasCursor component with the ErrorBoundary
const App = () => (
  <ErrorBoundary>
    <CanvasCursor />
  </ErrorBoundary>
